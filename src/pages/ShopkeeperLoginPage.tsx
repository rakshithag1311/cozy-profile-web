...
const DEMO_SHOPS = [
  { id: 'shop-1', password: 'pass123', name: 'Sharma General Store' },
  { id: 'shop-2', password: 'pass123', name: 'Annapurna Bakery' },
  { id: 'shop-3', password: 'pass123', name: 'Quick Stop Convenience' },
  { id: 'shop-4', password: 'pass123', name: 'Green Basket Organics' },
  { id: 'shop-5', password: 'pass123', name: 'Chai & Bites Cafe' },
  { id: 'shop-6', password: 'pass123', name: 'Mumbai Snack Corner' },
];
    ...
    <div className="page-container fade-in">
      <div className="content-container flex flex-col justify-center min-h-screen">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Shop ID</label>
            <div className="relative">
              <Store className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" />
              <input type="text" value={shopId} onChange={(e) => setShopId(e.target.value)} placeholder="Enter your Shop ID" className="input-field pl-12" required />
            </div>
          </div>
          <div>
            ...
            <div className="relative">
              ...
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" className="input-field pl-12" required />
            </div>
          </div>
        ...
        <div className="mt-8 p-4 bg-secondary rounded-xl">
          <p className="text-sm font-medium text-foreground mb-2">Demo login – no real credentials required</p>
          <p className="text-sm text-muted-foreground">Shop ID: shop-1, shop-2, ... shop-6</p>
